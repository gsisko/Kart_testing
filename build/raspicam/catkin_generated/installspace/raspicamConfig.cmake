...
if(NOT "/home/pi/ros_catkin_ws/install/include" STREQUAL "")
  set(raspicam_INCLUDE_DIRS "")
  set(absolute_include_dirs "/home/pi/ros_catkin_ws/install/include")
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY /home/pi/ros_catkin_ws/install/${idir})
      ...
      message(FATAL_ERROR "Project 'raspicam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/install/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
