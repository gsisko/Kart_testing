...
if(TRUE)
  set(raspicam_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/raspicam)
  set(raspicam_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel)
  set(raspicam_INSTALL_PREFIX "")
  set(raspicam_PREFIX ${raspicam_DEVEL_PREFIX})
else()
  set(raspicam_SOURCE_PREFIX "")
  set(raspicam_DEVEL_PREFIX "")
  set(raspicam_INSTALL_PREFIX /home/pi/ros_catkin_ws/install)
...
if(NOT "/home/pi/ros_catkin_ws/src/raspicam/include" STREQUAL "")
  set(raspicam_INCLUDE_DIRS "")
  set(absolute_include_dirs "/home/pi/ros_catkin_ws/src/raspicam/include")
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/pi/ros_catkin_ws/src/raspicam/${idir})
      set(include /home/pi/ros_catkin_ws/src/raspicam/${idir})
    else()
      message(FATAL_ERROR "Project 'raspicam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/raspicam/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
